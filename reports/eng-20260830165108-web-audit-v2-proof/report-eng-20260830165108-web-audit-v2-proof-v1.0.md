...
**Executive Risk Narrative — Engagement eng-20260830165108-web-audit-v2-proof**

The security assessment covering 2 assets and 5 endpoints identified 29 total findings, of which 2 are rated Critical and 6 are rated High — a concentration of severe risk within a limited attack surface that warrants immediate executive attention. Both Critical findings affect the Redis deployment: an integer overflow in Lua script handling (versions prior to 8.2.1) and a use-after-free condition in the Lua parser (prior to 8.2.2). These are memory-corruption class vulnerabilities that, depending on exposure, could enable remote code execution or denial of service against the data layer. This is compounded by a High-severity cross-user Lua sandbox escape (prior to 8.2.2), which undermines isolation boundaries and could allow one context to access another user's data or execution environment. The clustering of these flaws in a shared infrastructure component means a single compromised Redis instance represents a high-value pivot point across the environment.

At the application layer, two High-severity SQL injection vulnerabilities were confirmed via the POST `password` parameter, identified through differential analysis. Injection on an authentication path is particularly consequential: it may permit authentication bypass, exposure of credential stores, or broader database compromise, and it directly threatens the confidentiality and integrity of user accounts. The remaining findings (1 Medium, 20 Informational) reflect normal assessment noise, but the overall severity density — 8 of 29 findings rated High or Critical across only 5 endpoints — indicates an elevated risk posture. We recommend prioritized remediation: upgrade Redis to 8.2.2 or later as the immediate action, remediate the SQL injection flaws through parameterized queries and input validation, and verify the effectiveness of any compensating controls (WAF rules, network segmentation) in the interim. A focused retest should follow remediation to confirm closure of the Critical and High findings.

**CONFIDENTIAL**

## Assessment Overview
- **Total Assets Discovered:** 2
- **Total Endpoints Mapped:** 5
...
### 1. SQLI via POST parameter 'password' (web_audit differential)
- **Severity**: high
- **Type**: sqli
- **Target**: unknown
...
### 2. SQLI via POST parameter 'password' (web_audit differential)
- **Severity**: high
- **Type**: sqli
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
#### Proof of Concept / Evidence
```
[{"type": "web_audit_differential", "provenance": "web_audit", "url": "http://127.0.0.1:9199/login", "method": "POST", "parameter": "password", "baseline_value": "audit_probe_baseline_77", "probe": "' OR '1'='1", "baseline_status": 401, "injected_status": 200, "error_signature": false, "auth_bypass": true, "authenticated": true}]
```
**Artifact SHA-256 Hash**: `9bc9632d346daea24ee29ec196488072391948c3c906446e3efe7643971fdfcb`
**Chain of Custody ID**: `no-audit-event`

---

### 3. Redis < 8.2.1 lua script - Integer Overflow
- **Severity**: critical
- **Type**: rce
- **Target**: unknown
...
...[truncated 1985 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `42c34150227b457823566f0b347dcf9674e09fba9c113a7004653e4c87923129`
**Chain of Custody ID**: `no-audit-event`

---

### 5. Redis Lua Sandbox < 8.2.2 - Cross-User Escape
- **Severity**: high
- **Type**: rce
- **Target**: unknown
- **Attack Technique**: T1210 - Exploitation of Remote Services
...
...[truncated 1985 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `951eee93baf436ad24fa3e863862d4c8d1cf7bf8e7881e5efefcfd8b0abcae0e`
**Chain of Custody ID**: `no-audit-event`

---

### 6. Redis  < 8.2.1 Lua Long-String Delimiter - Out-of-Bounds Read
- **Severity**: high
- **Type**: rce
- **Target**: unknown
- **Attack Technique**: T1210 - Exploitation of Remote Services
...
...[truncated 1985 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `b2ceedcd9104a4bdc6774bbb04716a1602212ecf962d854821921c454ea2a403`
**Chain of Custody ID**: `no-audit-event`

---

### 7. Redis - Default Logins
- **Severity**: high
- **Type**: unknown
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
#### Proof of Concept / Evidence
```
[{"type": "nuclei_finding", "template": "redis-default-logins", "matched_at": "127.0.0.1:6379", "url": "127.0.0.1:6379", "request": "var m = require(\"nuclei/redis\");\nm.GetServerInfoAuth(Host, Port, Password);", "response": "# Server\r\nredis_version:7.0.15\r\nredis_git_sha1:00000000\r\nredis_git_dirty:0\r\nredis_build_id:e53ff17674aa6190\r\nredis_mode:standalone\r\nos:Linux 6.6.87.2-microsoft-standard-WSL2 x86_64\r\narch_bits:64\r\nmonotonic_clock:POSIX clock_gettime\r\nmultiplexing_api:epoll\r\natomicvar_api:c11-builtin\r\ngcc_version:13.3.0\r\nprocess_id:183\r\nprocess_supervised:systemd\r\nrun_id:c4fd36f69fbeb77f9c93943a881955f0c1760c8b\r\ntcp_port:6379\r\nserver_time_usec:1788109363227582\r\nuptime_in_seconds:81131\r\nuptime_in_days:0\r\nhz:10\r\nconfigured_hz:10\r\nlru_clock:9724467\r\nexecutable:/usr/bin/redis-server\r\nconfig_file:/etc/redis/redis.conf\r\nio_threads_active:0\r\n\r\n# Clients\r\nconnected_clients:2\r\ncluster_connections:0\r\nmaxclients:10000\r\nclient_recent_max_input_buffer:0\r\nclient_recent_max_output_buffer:0\r\nblocked_clients:0\r\ntracking_clients:0\r\nclients_in_timeout_table:0\r\n\r\n# Memory\r\nused_memory:1304848\r\nused_memory_human:1.24M\r\nused_memory_rss:9175040\r\nused_memory_rss_human:8.75M\r\nused_memory_peak:1532184\r\nused_memory_peak_human:1.46M\r\nused_memory_peak_perc:85.16%\r\nused_memory_overhead:879536\r\nused_memory_startup:876080\r\nused_memory_dataset:425312\r\nused_memory_dataset_perc:99.19%\r\nallocator_allocated:1820080\r\nallocator_active:2220032\r\nallocator_resident:7012352\r\ntotal_system_memory:8153923584\r\ntotal_system_memory_human:7.59G\r\nused_memory_lua:29696\r\nused_memory_vm_eval:29696\r\nused_memory_lua_human:29.00K\r\nused_memory_scripts_eval:152\r\nnumber_of_cached_scripts:1\r\nnumber_of_functions:0\r\nnumber_of_libraries:0\r\nused_memory_vm_functions:32768\r\nused_memory_vm_total:62464\r\nused_memory_vm_total_human:61.00K\r\nused_memory_functions:200\r\nused_memory_scripts:352\r\nused_memory_scripts_human:352B\r\nmaxmemory:0\r\nmaxmemory_human:0B\r\nmaxmemory_policy:noeviction\r\nallocator_frag_ratio:1.22\r\nallocator_frag_bytes:399952\r\nallocator_rss_ratio:3.16\r\nallocator_rss_bytes:4792320\r\nrss_overhead_ratio:1.31\r\nrss_overhead_bytes:2162688\r\nmem_fragmentation_ratio:7.48\r\nmem_fragmentation_bytes:7948216\r\nmem_not_counted_for_evict:0\r\nmem_replication_backlog:0\r\nmem_total_replication_buffers:0\r\nmem_clients_slaves:0\r\nmem_clients_normal:0\r\nmem_cluster_links:0\r\nmem_aof_buffer:0\r\nmem_allocator:jemalloc-5.3.0\r\nactive_defrag_running:0\r\nlazyfree_pending_objects:0\r\nlazyfreed_objects:0\r\n\r\n# Persistence\r\nloading:0\r\nasync_loading:0\r\ncurrent_cow_peak:0\r\ncurrent_cow_size:0\r\ncurrent_cow_size_age:0\r\ncurrent_fork_perc:0.00\r\ncurrent_save_keys_processed:0\r\ncurrent_save_keys_total:0\r\nrdb_changes_since_last_save:0\r\nrdb_bgsave_in_progress:0\r\nrdb_last_save_time:1788028232\r\nrdb_last_bgsave_status:ok\r\nrdb_last_bgsave_time_sec:-1\r\nrdb_current_bgsave_time_sec:-1\r\nrdb_saves:0\r\nrdb_last_cow_size:0\r\nrdb_last_load_keys_expired:0\r\nrdb_last_load_keys_loaded:64\r\naof_enabled:0\r\naof_rewrite_in_progress:0\r\naof_rewrite_scheduled:0\r\naof_last_rewrite_time_sec:-1\r\naof_current_rewrite_time_sec:-1\r\naof_last_bgrewrite_status:ok\r\naof_rewrites:0\r\naof_rewrites_consecutive_failures:0\r\naof_last_write_status:ok\r\naof_last_cow_size:0\r\nmodule_fork_in_progress:0\r\nmodule_fork_last_cow_size:0\r\n\r\n# Stats\r\ntotal_connections_received:2210\r\ntotal_commands_processed:3252\r\ninstantaneous_ops_per_sec:9\r\ntotal_net_input_bytes:295822\r\ntotal_net_output_bytes:4098667\r\ntotal_net_repl_input_bytes:0\r\ntotal_net_repl_output_bytes:0\r\ninstantaneous_input_kbps:0.60\r\ninstantaneous_output_kbps:3.87\r\ninstantaneous_input_repl_kbps:0.00\r\ninstantaneous_output_repl_kbps:0.00\r\nrejected_connections:0\r\nsync_full:0\r\nsync_partial_ok:0\r\nsync_partial_err:0\r\nexpired_keys:0\r\nexpired_stale_perc:0.00\r\nexpired_tim

...[truncated 1963 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `26225a7ded12e3e21fa90ccbde78dae4f2c2b4ca6f7e97109c4b04ee089b52ba`
**Chain of Custody ID**: `no-audit-event`

---

### 8. Redis Server - Unauthenticated Access
- **Severity**: high
- **Type**: unknown
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
```
**Artifact SHA-256 Hash**: `0f2420d3128430f2b90eb8127abefad7a075f533d186bb31a1f1c2113de3e343`
**Chain of Custody ID**: `no-audit-event`

---

### 12. robots.txt endpoint prober
- **Severity**: info
- **Type**: unknown
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
```
**Artifact SHA-256 Hash**: `df4ad5aa987abd02b6ea891520c09a47193c4428d0a217f246c586f5ba09aef0`
**Chain of Custody ID**: `no-audit-event`
...
```
**Artifact SHA-256 Hash**: `526ada5c06df7c6f3154763ca39d6ae2e1efbda012dcf788fe5f5efe131d3ae3`
**Chain of Custody ID**: `no-audit-event`
...
...[truncated 7234 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `27c5c271b204b0e9ba6562dd6f706e2b9431fd88a045b51a2078f9e75b8abb92`
**Chain of Custody ID**: `no-audit-event`

---

### 25. Deprecated Feature-Policy Header - Detection
- **Severity**: info
- **Type**: unknown
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
...[truncated 7188 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `4fee4f15b19bf7bc8881c1867c4fc8886c0fb4205976fe19bf3c799ff233515b`
**Chain of Custody ID**: `no-audit-event`
...
...[truncated 7234 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `5aea4d3c368ca74047316f5fbe5ecba73c4b8a5c3058674b21c80206f2956d07`
**Chain of Custody ID**: `no-audit-event`

---

### 27. FingerprintHub Technology Fingerprint
- **Severity**: info
- **Type**: unknown
- **Target**: unknown
- **Attack Technique**: T1190 - Exploit Public-Facing Application
...
...[truncated 7191 chars — full evidence in the evidence vault; sha256 above covers the complete artifact]
```
**Artifact SHA-256 Hash**: `c38f5c9923e264fa4ad9bde03716113ec75d180efdbe17b0c9be1621785ac0f2`
**Chain of Custody ID**: `no-audit-event`
