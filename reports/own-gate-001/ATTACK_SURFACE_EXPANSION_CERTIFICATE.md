...
$$\text{Expansion Ratio} = \frac{\text{Persisted Endpoints} (5) + \text{Parameters} (2) + \text{API Routes} (0) + \text{JS Bundles} (0)}{\text{Input Targets} (1)} = 7x$$
