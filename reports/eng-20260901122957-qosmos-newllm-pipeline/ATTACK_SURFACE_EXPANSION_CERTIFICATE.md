...
| **Raw URLs Discovered** | 40 | Active Crawler Link Harvester |
...
$$\text{Expansion Ratio} = \frac{\text{Persisted Endpoints} (8) + \text{Parameters} (0) + \text{API Routes} (3) + \text{JS Bundles} (0)}{\text{Input Targets} (1)} = 11x$$
