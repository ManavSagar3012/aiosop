...
_TAXONOMY: Dict[str, VulnTaxon] = {
    ...
    "stored_xss": VulnTaxon(
        "CWE-79", "CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:C/C:H/I:L/A:N", 8.3, "high"
    ),
    "idor": VulnTaxon(
        "CWE-639", "CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N", 6.5, "medium"
    ),
    "broken_access_control": VulnTaxon(
        "CWE-284", "CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N", 8.1, "high"
    ),
    "mass_assignment": VulnTaxon(
        "CWE-915", "CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N", 8.1, "high"
    ),
    "jwt_abuse": VulnTaxon(
        "CWE-347", "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N", 9.1, "critical"
    ),
    "csrf": VulnTaxon(
        "CWE-352", "CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:H/A:N", 6.5, "medium"
    ),
    "authentication_weakness": VulnTaxon(
        "CWE-287", "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", 7.5, "high"
    ),
    "ssrf": VulnTaxon(
        "CWE-918", "CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:C/C:H/I:L/A:N", 8.5, "high"
    ),
    "xxe": VulnTaxon(
        "CWE-611", "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", 7.5, "high"
    ),
    "open_redirect": VulnTaxon(
        "CWE-601", "CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:L/I:L/A:N", 4.7, "medium"
    ),
